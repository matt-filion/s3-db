...
describe('#build()', () => {
  ...
  it('Make sure all keys exist.',() => expect( document ).to.have.all.keys(Common.METANAME,'abc','rename','delete','getId','id','isModified','refresh','save','copyTo','getMetadata','getHead'));
